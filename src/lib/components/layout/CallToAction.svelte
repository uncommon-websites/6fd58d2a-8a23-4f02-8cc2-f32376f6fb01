...
<script lang="ts">
	...
	// Props
	const {
		title = "AI automation in minutes, not months",
		subtitle = "Join engineering teams shipping AI 10x faster",
		description = "Don't let complexity kill your roadmap. Agentify gives your team the tools to go from prototype to production—without hiring AI specialists or rebuilding your backend. Ship your first agent in under an hour.",
		imageSrc = "/generated/image-a-joyful-product-manager-sitting-at-a-co.webp",
		callsToAction = [cta],
		...rest
	}: {
		title?: string;
